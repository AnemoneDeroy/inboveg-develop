...
Example
  ...
  * N2000 <- "4010"
  * Classifiction <- classification_info(SurveyName, N2000, con)
...
Example 
  * SurveyName <- "xxx"
  * BWK <- "xx"
  * Classifiction <- classification_info(SurveyName, BWK, con)
  * Classifiction <- classification_info("xx", "xx", con) ## nog goed voorbeeld zoeken
