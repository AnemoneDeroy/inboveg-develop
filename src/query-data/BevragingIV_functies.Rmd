...
survey <- input_name_survey
part_survey <- part_of_the_surveyname
owner <- owner_of_the_Survey
...
- specify the bwk-code or N2000 code to retrieve all relevés indicated as this code
...
werkt nog niet, geeft lege rij. hoe omgaan met de 'or' ... of surveyname of bwkcode of n2K code....? 

Ophalen vegetatieopnames
